...
def get_data():
    if os.path.isdir('data') == False:
        ...
        process = subprocess.Popen('chmod +x ./get_data.sh',stdout=subprocess.PIPE,
...
def upload_file():
    ...
    gfile = drive.CreateFile({'parents': [{'id': '1UmD1_yE5nz5jcZPGDyK2iI-I-7a-P7Mj'}],'title':'hello123.txt'})
